...
# vertx-grpc-java-compiler 1.3.0
...
1. Run a diff between the gRPC tags, replace the versions in the [link](https://github.com/grpc/grpc-java/compare/v1.2.0...v1.3.0)
