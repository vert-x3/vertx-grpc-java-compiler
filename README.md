...
# vertx-grpc-java-compiler 1.16.1
...
1. Run a diff between the gRPC tags, replace the versions in the [link](https://github.com/grpc/grpc-java/compare/v1.16.1...v1.16.x)
